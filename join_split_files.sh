...
cat system_ext/apex_payload.img.* 2>/dev/null >> system_ext/apex_payload.img
rm -f system_ext/apex_payload.img.* 2>/dev/null
...
cat system_ext/priv-app/SettingsMoto/SettingsMoto.apk.* 2>/dev/null >> system_ext/priv-app/SettingsMoto/SettingsMoto.apk
rm -f system_ext/priv-app/SettingsMoto/SettingsMoto.apk.* 2>/dev/null
...
cat vendor_boot/dtb/02_dtbdump__qcom,rtic-id.dtb.* 2>/dev/null >> vendor_boot/dtb/02_dtbdump__qcom,rtic-id.dtb
rm -f vendor_boot/dtb/02_dtbdump__qcom,rtic-id.dtb.* 2>/dev/null
...
cat product/app/Maps/oat/arm64/Maps.vdex.* 2>/dev/null >> product/app/Maps/oat/arm64/Maps.vdex
rm -f product/app/Maps/oat/arm64/Maps.vdex.* 2>/dev/null
...
cat product/priv-app/MotoAppUIRefresh/MotoAppUIRefresh.apk.* 2>/dev/null >> product/priv-app/MotoAppUIRefresh/MotoAppUIRefresh.apk
rm -f product/priv-app/MotoAppUIRefresh/MotoAppUIRefresh.apk.* 2>/dev/null
cat product/priv-app/GmsCore/GmsCore.apk.* 2>/dev/null >> product/priv-app/GmsCore/GmsCore.apk
rm -f product/priv-app/GmsCore/GmsCore.apk.* 2>/dev/null
cat product/priv-app/AiServices/AiServices.apk.* 2>/dev/null >> product/priv-app/AiServices/AiServices.apk
rm -f product/priv-app/AiServices/AiServices.apk.* 2>/dev/null
cat product/priv-app/Velvet/Velvet.apk.* 2>/dev/null >> product/priv-app/Velvet/Velvet.apk
rm -f product/priv-app/Velvet/Velvet.apk.* 2>/dev/null
cat product/priv-app/MotoDesktop/MotoDesktop.apk.* 2>/dev/null >> product/priv-app/MotoDesktop/MotoDesktop.apk
rm -f product/priv-app/MotoDesktop/MotoDesktop.apk.* 2>/dev/null
cat product/priv-app/MotCamera4/MotCamera4.apk.* 2>/dev/null >> product/priv-app/MotCamera4/MotCamera4.apk
rm -f product/priv-app/MotCamera4/MotCamera4.apk.* 2>/dev/null
